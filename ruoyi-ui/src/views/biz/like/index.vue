<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="likeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="点赞编号" prop="id"/>
...
<script>
import {addLike, delLike, exportLike, getLike, listLike, updateLike} from "@/api/biz/like";
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有点赞数据项？').then(() => {
