  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="3">
        周期从
        <el-input-number v-model='cycle01' :max="31" :min="0"/>
        -
        <el-input-number v-model='cycle02' :max="31" :min="0"/>
        日
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="4">
        从
        <el-input-number v-model='average01' :max="31" :min="0"/>
        号开始，每
        <el-input-number v-model='average02' :max="31" :min="0"/>
        日执行一次
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="5">
        每月
        <el-input-number v-model='workday' :max="31" :min="0"/>
        号最近的那个工作日
      </el-radio>
    </el-form-item>
