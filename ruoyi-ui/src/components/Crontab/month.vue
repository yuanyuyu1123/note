  ...
  <el-form size='small'>
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="2">
        周期从
        <el-input-number v-model='cycle01' :max="12" :min="1"/>
        -
        <el-input-number v-model='cycle02' :max="12" :min="1"/>
        月
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="3">
        从
        <el-input-number v-model='average01' :max="12" :min="1"/>
        月开始，每
        <el-input-number v-model='average02' :max="12" :min="1"/>
        月月执行一次
      </el-radio>
    </el-form-item>
