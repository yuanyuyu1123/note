  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="2">
        周期从
        <el-input-number v-model='cycle01' :max="60" :min="0"/>
        -
        <el-input-number v-model='cycle02' :max="60" :min="0"/>
        秒
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="3">
        从
        <el-input-number v-model='average01' :max="60" :min="0"/>
        秒开始，每
        <el-input-number v-model='average02' :max="60" :min="0"/>
        秒执行一次
      </el-radio>
    </el-form-item>
