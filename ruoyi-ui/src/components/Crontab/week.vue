  ...
  <el-form size='small'>
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="3">
        周期从星期
        <el-input-number v-model='cycle01' :max="7" :min="1"/>
        -
        <el-input-number v-model='cycle02' :max="7" :min="1"/>
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="4">
        ...
        周的星期
        <el-input-number v-model='average02' :max="7" :min="1"/>
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="5">
        本月最后一个星期
        <el-input-number v-model='weekday' :max="7" :min="1"/>
      </el-radio>
    </el-form-item>
